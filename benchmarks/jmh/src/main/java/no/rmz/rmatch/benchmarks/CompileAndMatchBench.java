 ...
 */
        ...
        patterns = java.util.stream.IntStream.range(0, patternCount)
        .mapToObj(i -> "a.*b" + i)
        .toList();
        ...
        // Replace the fabricated addPattern(byte[]) and match(byte[]) calls with the real API used in your codebase.
