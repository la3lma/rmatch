...
2. Run the sample benchmark:
   ...
   ```bash
   python benchmarking/framework/runner.py \
     --patterns benchmarking/framework/patterns/sample_patterns.txt \
     --corpus benchmarking/framework/corpora/sample_corpus.txt \
     --engines benchmarking/framework/configs/example_engines.json \
     --output-dir benchmarking/framework/results/sample
   ```
