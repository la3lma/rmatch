...
public final class MultiJavaRegexpMatchDetector implements MatchDetector {
  ...
  public static final Callable<Object> makeMatchPerformer(
      final LineSource linesource, final Matcher rmatcher, final Action actionToRun) {
  ...
  public static void main(final String[] argv) throws RegexpParserException {
    ...
    final MatchDetector matchDetector = new MultiJavaRegexpMatchDetector(lineSource);
