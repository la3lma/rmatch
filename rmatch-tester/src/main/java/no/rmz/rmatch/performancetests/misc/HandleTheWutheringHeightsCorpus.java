...
/**
 * A test scenario that will match a bunch of regular expressions against the text of Emily Brontes
 * Wuthering Heights.
 */
public final class HandleTheWutheringHeightsCorpus {
  ...
  /**
   * Set up the test by inhaling the corpus, enabling the regexps and running the match.
   *
