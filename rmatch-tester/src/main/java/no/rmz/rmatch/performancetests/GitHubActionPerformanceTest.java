...
/**
 * Performance test runner designed for GitHub Actions that orchestrates comparison
 * between rmatch and JavaRegexpMatcher implementations.
 */
public final class GitHubActionPerformanceTest {
    ...
    public static class ComparisonResult {
        ...
        public List<MatcherBenchmarker.TestRunResult> getRmatchResults() { return rmatchResults; }
        public List<MatcherBenchmarker.TestRunResult> getJavaResults() { return javaResults; }
        public List<MatcherBenchmarker.TestRunResult> getBaselineRmatchResults() { return baselineRmatchResults; }
        public List<MatcherBenchmarker.TestRunResult> getBaselineJavaResults() { return baselineJavaResults; }
        public PerformanceCriteriaEvaluator.PerformanceResult getPerformanceResult() { return performanceResult; }
    }
    ...
    public static ComparisonResult runComparison(
        ...
        try {
            ...
            for (int run = 1; run <= numRuns; run++) {
                ...
                LOG.info("Run " + run + " completed - rmatch: " + rmatchResult.durationInMillis() + 
                        "ms, java: " + javaResult.durationInMillis() + "ms");
            }
            ...
            return new ComparisonResult(rmatchResults, javaResults, 
                                      baselineRmatchResults, baselineJavaResults, performanceResult);
     ...
     * @return ComparisonResult with performance analysis
     */
    public static ComparisonResult runComparison(int maxRegexps, 
                                               List<MatcherBenchmarker.TestRunResult> baselineResults) {
        return runComparison(
            "rmatch-tester/corpus/wuthering-heights-by-emily-bronte.txt",
