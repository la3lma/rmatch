...
/** A short & sweet example of how to use the rmatch matcher library. */
public final class HelloMatch {

  /** Errors can occur, and when they do we log them. */
  private static final Logger LOG = Logger.getLogger(HelloMatch.class.getName());
  ...
  public static void main(final String[] argv) {
    try {
      ...
      final Action a =
          (b, start, end) ->
              System.out.println("Match found: '" + b.getString(start, end + 1) + "'");
