...
/**
 * Manages performance baseline data for comparison with current test results.
 * Handles loading, storing, and updating baseline performance metrics.
 */
public final class BaselineManager {
    ...
    public static class BaselineData {
        ...
        public BaselineData(String timestamp, EnvironmentInfo environment, 
        ...
        public List<MatcherBenchmarker.TestRunResult> getResults() { return results; }
    }
    ...
    public static class EnvironmentInfo {
        ...
        public EnvironmentInfo(String javaVersion, String osName, String osVersion, 
     ...
     */
    public static void saveRmatchBaseline(String baselineDir, List<MatcherBenchmarker.TestRunResult> results) {
     ...
     * @param results Test results to save as new baseline
     */
    public static void saveJavaBaseline(String baselineDir, List<MatcherBenchmarker.TestRunResult> results) {
    ...
    private static List<MatcherBenchmarker.TestRunResult> loadBaseline(String baselineDir, String filename) {
        Path baselinePath = Paths.get(baselineDir, filename);
                ...
                if (parts.length >= 3) {
                    try {
                        ...
                        MatcherBenchmarker.TestRunResult result = 
                            new MatcherBenchmarker.TestRunResult(matcherTypeName, Collections.emptyList(), 
                                                               usedMemoryInMb, durationInMillis);
                        results.add(result);
    ...
    private static void saveBaseline(String baselineDir, String filename, 
                                   List<MatcherBenchmarker.TestRunResult> results) {
        try {
            ...
            try (PrintWriter writer = new PrintWriter(Files.newBufferedWriter(baselinePath))) {
                ...
                for (MatcherBenchmarker.TestRunResult result : results) {
                    writer.printf("%s,%d,%d%n", 
                        result.matcherTypeName(), 
                        result.usedMemoryInMb(), 
                        result.durationInMillis());
                }
            }
