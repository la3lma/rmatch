...
public class LineSource {
    ...
    /**
     * The index into some outer entity, where the start of the
     * current line was gotten from.
     */
    private int currentStartOfLine = 0;

    /**
     * We need a method to access the currentLine since it isn't final, and
     * the access is being made from inside an anonymous class definition.
     *
