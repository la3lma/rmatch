...
/**
 * The result of reading a corpus. This record will be used when logging the results of the test
 * run.
 */
public final class CorpusTestResult {
   ...
   * @param maxNoOfMbsUsed The number of megabytes use (max) during the test run.
   */
