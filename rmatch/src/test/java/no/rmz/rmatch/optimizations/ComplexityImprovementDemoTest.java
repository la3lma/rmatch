...
/** 
 * Integration test demonstrating the O(l*m) complexity fix through
 * performance characteristics with diverse pattern sets.
 */
public class ComplexityImprovementDemoTest {

  /** 
   * Test that demonstrates the optimization provides good performance
   * even with many diverse patterns.
   */
  @Test
  public void testPerformanceWithDiversePatterns() throws Exception {
    ...
    assertTrue(timeMs < 500, "Should complete in under 500ms with optimization, took: " + timeMs + "ms");
  ...
  private String generateLongInput(int targetLength) {
    ...
    String[] words = {
        "alpha1test", "beta2data", "gamma3info", "delta4word", "epsilon5text",
        "random", "text", "data", "information", "processing", "matching", "patterns",
        "performance", "optimization", "algorithm", "complexity", "efficiency"
    };
