...
/** Testing the domination protocol, with contributions from misc. classes. */
public final class RegexpDominationProtocolTest {
  ...
  /**
   * Create a match set, generate a new match associated with this matchset, and observe that the
   * regular expression has matches associated with it.
   */
  @Test
  ...
  /**
   * Establish a match associated with a regular expression, then abandon that match, and then
   * observe that the regexp is no longer associated with that match.
   */
  @Test
  ...
  /**
   * Test that a match starting at point 1 and ending at point 2 will be dominated by a match
   * starting at point 1 and ending at point 3.
   */
  @Test
  ...
  /**
   * Test that a match starting at point 1 and ending at point 3 will dominate a match starting at
   * point 2 and ending at point 3.
   */
  @Test
