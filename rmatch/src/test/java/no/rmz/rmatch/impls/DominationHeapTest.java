...
public class DominationHeapTest {
  ...
  /** A domination heap. Really a part of the fixture since we're just testing the comparator. */
  DominationHeap heap;
  ...
  /** A mocked comparator for matches. TODO what does it do? */
  @Mock Comparator<Match> comparator;

  /**
   * Set up test items and surrounding context. IN particular, set up the m1>m2 ordering that will
   * be used in many a situation of this test. The ordering is implemented using mocking.
   */
  @BeforeEach
  public void setUp() {
  ...
  /** Adding an element to an empty heap, then removing it and again getting an empty heap. */
  @Test
