...
/**
 * A compiler that can be primed with predigested compilation results, enabling it to compile known
 * regular expressions into known NDFAnodes representing them.
 */
public final class MockerCompiler implements NDFACompiler {
   ...
   *
   * @param mockedCompilationResult the result that will used by this "compiler" to look up its
