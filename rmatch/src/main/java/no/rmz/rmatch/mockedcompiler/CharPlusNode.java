...
/**
 * A node, used for testing, that will recognize a single or more instances of a particular
 * character.
 */
public final class CharPlusNode extends AbstractNDFANode {
   ...
   * @param isTerminal True iff this node represents legal terminations of the regexp r.
   */
  public CharPlusNode(final Character ch, final Regexp r, final boolean isTerminal) {
    super(r, isTerminal);
