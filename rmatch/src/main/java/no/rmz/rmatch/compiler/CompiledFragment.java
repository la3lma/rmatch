...
/**
 * Represent a compiled fragment of a regexp. In general there will be an arrival node and an ending
 * node. There may or may not be some nodes i between (usually there are) but these are typically
 * generated by a compiler, and then glued to the arrival and ending nodes through epsilon edges.
 */
