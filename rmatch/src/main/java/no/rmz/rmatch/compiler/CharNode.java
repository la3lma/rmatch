...
public final class CharNode extends AbstractNDFANode {
   ...
   */
  public CharNode(final NDFANode nextNode, final Character ch, final Regexp r) {
   ...
   */
  private CharNode(
      final NDFANode nextNode, final Character ch, final Regexp r, final boolean isTerminal) {
    super(r, isTerminal);
