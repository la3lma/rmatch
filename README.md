...
|--------|--------|------------|---------------------|
| **5000 patterns** | 15.3s | 4.1s | 3.7x slower |
...
*Latest benchmark comparison between rmatch and native Java regex (java.util.regex.Pattern) on 5000 regex patterns against Wuthering Heights corpus. Updated: 2025-11-06 13:40 UTC*
