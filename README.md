...
|--------|--------|------------|---------------------|
| **5000 patterns** | 18.9s | 4.1s | 4.6x slower |
...
*Latest benchmark comparison between rmatch and native Java regex (java.util.regex.Pattern) on 5000 regex patterns against Wuthering Heights corpus. Updated: 2025-11-05 08:51 UTC*
