...
|--------|--------|------------|---------------------|
| **5000 patterns** | 18.5s | 4.1s | 4.5x slower |
...
*Latest benchmark comparison between rmatch and native Java regex (java.util.regex.Pattern) on 5000 regex patterns against Wuthering Heights corpus. Updated: 2025-11-05 09:17 UTC*
