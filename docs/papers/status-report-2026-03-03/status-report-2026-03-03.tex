...
\begin{itemize}
  ...
  \item benchmark control and protocol docs in \texttt{benchmarking/framework/regex\_bench\_framework/docs}
  \item aggregated benchmark outputs in \texttt{benchmarking/framework/regex\_bench\_framework/reports/workload\_all\_live}
...
The current benchmark control plane uses the Python framework under \texttt{benchmarking/framework/regex\_bench\_framework}, containerized execution, and GCP run control.
...
\begin{figure}[h!]
\centering
\includegraphics[page=2,width=0.95\linewidth]{../../../benchmarking/framework/regex_bench_framework/reports/workload_all_live/modeling_dominance_note.pdf}
